...
const CONFIG_TOOL_DEFINITIONS = [
  ...
  },
  {
    ...
    description: '[WRITE OPERATION — requires dryRun=false for live execution. User must hold valid SAP Named User license.] Write configuration to target system. Respects dryRun flag and transport requirements.',
    inputSchema: {
      type: 'object',
      properties: {
