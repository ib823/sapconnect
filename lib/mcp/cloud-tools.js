...
const CLOUD_TOOL_DEFINITIONS = [
  {
    ...
    description: '[WRITE OPERATION — requires dryRun=false for live execution. User must hold valid SAP Named User license.] Sync migration project with SAP Cloud ALM. Creates or updates the project definition, phases, and task structure.',
    inputSchema: {
      type: 'object',
      properties: {
  ...
  },
  {
    ...
    description: '[WRITE OPERATION — requires dryRun=false for live execution. User must hold valid SAP Named User license.] Sync a specific task to SAP Cloud ALM. Updates task status, assignee, and metadata.',
    inputSchema: {
      type: 'object',
      properties: {
  ...
  },
  {
    ...
    description: '[WRITE OPERATION — requires dryRun=false for live execution. User must hold valid SAP Named User license.] Push migration status update to SAP Cloud ALM dashboard.',
    inputSchema: {
      type: 'object',
      properties: {
  ...
  },
  {
    ...
    description: '[WRITE OPERATION — requires dryRun=false for live execution. User must hold valid SAP Named User license.] Create an issue or defect in SAP Cloud ALM for tracking migration problems.',
    inputSchema: {
      type: 'object',
      properties: {
  ...
  },
  {
    ...
    description: '[WRITE OPERATION — requires dryRun=false for live execution. User must hold valid SAP Named User license.] Provision BTP services for migration. Supports dry-run mode for cost estimation.',
    inputSchema: {
      type: 'object',
      properties: {
