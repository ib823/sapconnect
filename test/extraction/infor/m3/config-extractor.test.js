const InforM3ConfigExtractor = require('../../../../extraction/infor/m3/config-extractor');
const ExtractionContext = require('../../../../extraction/extraction-context');

describe('InforM3ConfigExtractor', () => {
  it('should have correct identity', () => {
    const ctx = new ExtractionContext({ mode: 'mock' });
    const ext = new InforM3ConfigExtractor(ctx);
    expect(ext.extractorId).toBe('INFOR_M3_CONFIG');
