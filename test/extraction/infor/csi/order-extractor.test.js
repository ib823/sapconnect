const InforCSIOrderExtractor = require('../../../../extraction/infor/csi/order-extractor');
const ExtractionContext = require('../../../../extraction/extraction-context');

describe('InforCSIOrderExtractor', () => {
  it('should have correct identity', () => {
    const ctx = new ExtractionContext({ mode: 'mock' });
    const ext = new InforCSIOrderExtractor(ctx);
    expect(ext.extractorId).toBe('INFOR_CSI_ORDERS');
